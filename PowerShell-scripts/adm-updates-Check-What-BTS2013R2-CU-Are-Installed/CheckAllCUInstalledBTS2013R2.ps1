#Name template for BizTalk Server CU's for BizTalk Server 2013 R2 (normally they are "Microsoft BizTalk Server 2013 R2 CU#")
$CUNameTemplate = 'BizTalk Server 2013 R2 CU'
