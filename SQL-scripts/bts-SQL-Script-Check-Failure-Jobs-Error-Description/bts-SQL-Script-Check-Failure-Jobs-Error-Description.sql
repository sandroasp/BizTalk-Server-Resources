...
WHERE MR.[LastRunStatus] like 'Failed' and LastRunDateTime > DATEADD(HH,-1, GETDATE())
and JobName IN ('Backup BizTalk Server (BizTalkMgmtDb)','CleanupBTFExpiredEntriesJob_BizTalkMgmtDb', 
