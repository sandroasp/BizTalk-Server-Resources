...
namespace Microsoft.BizTalk.FileRADITZ.Adapter
{
    ...
    /// </summary>
    internal abstract class FileRADITZCommonProperties : ConfigProperties
    {
        ...
        public FileRADITZCommonProperties()
        {
        }
    ...
    /// </summary>
    internal class FileRADITZReceiveProperties : FileRADITZCommonProperties
	{
		// Handler properties
        ...
        public FileRADITZReceiveProperties () : base()
        {
            // establish defaults
	...
	/// </summary>
    internal class FileRADITZTransmitProperties : FileRADITZCommonProperties
    {
		// Handler properties
		...
		//   FileRADITZAsyncTransmitterBatch.cs within the run-time project must be
        ...
        public FileRADITZTransmitProperties(IBaseMessage message, string propertyNamespace)
		{
		...
		public void UpdateUriForDynamicSend()
		{
			if (!String.IsNullOrEmpty(this.Uri))
			{
				...
				const string adapterAlias = "FileRADITZ://";
